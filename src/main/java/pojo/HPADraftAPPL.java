...
public class HPADraftAPPL {
	...
	public int getFncr_pincode() {
		return fncr_pincode;
	}

	public void setFncr_pincode(int fncr_pincode) {
	...
	public void setOff_cd(String off_cd2) {
		this.off_cd = off_cd2;
	}
	...
	public void setPur_cd(String pur_cd2) {
		this.pur_cd = pur_cd2;
	}
